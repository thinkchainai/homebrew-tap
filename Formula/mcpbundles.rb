class Mcpbundles < Formula
  ...
  url "https://files.pythonhosted.org/packages/56/bc/e6a77be40f3298ddce49b238f89f748a4ff57811896312de789b7ae91c91/mcpbundles-1.5.14.tar.gz"
  sha256 "0d59863a3192f79233d108c6cc68c9f44ff74d2ec28b84928978a858b0c502f1"
  license "MIT"
  ...
  resource "playwright-macos-arm64" do
  ...
  resource "playwright-macos-x86_64" do
  ...
  def install
    ...
    wheel_resource = Hardware::CPU.arm? ? resource("playwright-macos-arm64") : resource("playwright-macos-x86_64")
    venv.pip_install resources.reject { |r| r.name.start_with?("playwright-macos-") }
